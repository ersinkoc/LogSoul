...
class LogSoulCLI {
    ...
    async init() {
        console.log(chalk_1.default.blue((0, i18n_1.t)('cli.init.title')));
        if (!fs.existsSync('./logsoul.yaml')) {
            ...
            console.log(chalk_1.default.green((0, i18n_1.t)('cli.init.configCreated')));
        }
        console.log(chalk_1.default.green((0, i18n_1.t)('cli.init.success')));
        console.log(chalk_1.default.dim((0, i18n_1.t)('cli.init.nextSteps')));
        console.log(chalk_1.default.dim(`  ${(0, i18n_1.t)('cli.init.discover')}`));
        console.log(chalk_1.default.dim(`  ${(0, i18n_1.t)('cli.init.server')}`));
    }
    async discover() {
        console.log(chalk_1.default.blue((0, i18n_1.t)('cli.discover.title')));
        const result = await this.discovery.discoverLogs();
        console.log(chalk_1.default.green(`\n${(0, i18n_1.t)('cli.discover.complete')}`));
        console.log(chalk_1.default.white((0, i18n_1.t)('cli.discover.logFiles', result.log_files.length)));
        console.log(chalk_1.default.white((0, i18n_1.t)('cli.discover.domains', result.domains.size)));
        ...
        if (result.errors.length > 0) {
            console.log(chalk_1.default.yellow(`\n${(0, i18n_1.t)('cli.discover.errors', result.errors.length)}`));
    ...
    async listDomains() {
        ...
        if (domains.length === 0) {
            console.log(chalk_1.default.yellow((0, i18n_1.t)('cli.list.empty')));
            return;
        }
        console.log(chalk_1.default.blue((0, i18n_1.t)('cli.list.title') + '\n'));
        for (const domain of domains) {
            ...
            console.log(chalk_1.default.gray(`   ${(0, i18n_1.t)('cli.list.lastSeen', domain.last_seen.toLocaleString())}`));
            if (stats) {
                console.log(chalk_1.default[healthColor](`   ${(0, i18n_1.t)('cli.list.health', healthScore)}`));
                console.log(chalk_1.default.gray(`   ${(0, i18n_1.t)('cli.list.requests', stats.requests_per_minute.toFixed(1))}`));
                console.log(chalk_1.default.gray(`   ${(0, i18n_1.t)('cli.list.errorRate', stats.error_rate.toFixed(1))}`));
            }
            console.log();
        }
    }
    async addDomain(domainName) {
        try {
            ...
            console.log(chalk_1.default.green((0, i18n_1.t)('cli.success.domainAdded', domainName)));
        }
        catch (error) {
            console.error(chalk_1.default.red((0, i18n_1.t)('cli.errors.addFailed', error)));
        }
    }
    async watchDomain(domainName, options) {
        const domain = await this.storage.getDomain(domainName);
        if (!domain) {
            console.error(chalk_1.default.red((0, i18n_1.t)('cli.errors.domainNotFound', domainName)));
            console.log(chalk_1.default.dim((0, i18n_1.t)('cli.errors.discoverFirst')));
            return;
        }
        console.log(chalk_1.default.blue((0, i18n_1.t)('cli.watch.title', domainName)));
        console.log(chalk_1.default.dim((0, i18n_1.t)('cli.watch.stop') + '\n'));
        const logFiles = await this.discovery.findDomainLogs(domainName);
        if (logFiles.length === 0) {
            console.log(chalk_1.default.yellow((0, i18n_1.t)('cli.watch.noLogs', domainName)));
            return;
        }
    ...
    async showStats(domainName, options) {
        ...
        if (!stats) {
            console.log(chalk_1.default.yellow((0, i18n_1.t)('cli.stats.noData', domainName, timeRange)));
            return;
        }
        console.log(chalk_1.default.blue((0, i18n_1.t)('cli.stats.title', domainName, timeRange) + '\n'));
        const healthColor = stats.health_score >= 80 ? 'green' :
            stats.health_score >= 60 ? 'yellow' : 'red';
        console.log(chalk_1.default.white((0, i18n_1.t)('cli.stats.healthScore', chalk_1.default[healthColor](stats.health_score))));
        console.log(chalk_1.default.white((0, i18n_1.t)('cli.stats.requestsPerMin', chalk_1.default.cyan(stats.requests_per_minute.toFixed(1)))));
        console.log(chalk_1.default.white((0, i18n_1.t)('cli.stats.errorRate', chalk_1.default.red(stats.error_rate.toFixed(1)))));
        console.log(chalk_1.default.white((0, i18n_1.t)('cli.stats.avgResponseTime', chalk_1.default.yellow(stats.avg_response_time.toFixed(2)))));
        console.log(chalk_1.default.white((0, i18n_1.t)('cli.stats.trafficVolume', chalk_1.default.magenta(this.formatBytes(stats.traffic_volume)))));
        console.log(chalk_1.default.white((0, i18n_1.t)('cli.stats.uniqueIPs', chalk_1.default.blue(stats.unique_ips.toString()))));
    }
    async analyze(domainName, options) {
        ...
        console.log(chalk_1.default.blue((0, i18n_1.t)('cli.analyze.title', domainName, options.hour ? '1h' : options.day ? '24h' : options.week ? '7d' : '1h')));
        const timeRange = options.hour ? '1h' :
            options.day ? '24h' :
                options.week ? '7d' : '1h';
    ...
    async startServer() {
        console.log(chalk_1.default.blue((0, i18n_1.t)('cli.server.starting')));
        console.log(chalk_1.default.green((0, i18n_1.t)('cli.server.available', this.config.server.port)));
        ...
        server.listen(this.config.server.port, this.config.server.host, () => {
            console.log(chalk_1.default.green((0, i18n_1.t)('cli.server.running', this.config.server.host, this.config.server.port)));
            console.log(chalk_1.default.blue((0, i18n_1.t)('cli.server.dashboard', this.config.server.host, this.config.server.port)));
        });
    }
    async generateTestData() {
        ...
        console.log(chalk_1.default.green((0, i18n_1.t)('cli.success.testDataGenerated')));
    }
        ...
        try {
            if (fs.existsSync(configPath)) {
                ...
                if (cliConfig.language && (cliConfig.language === 'en' || cliConfig.language === 'tr')) {
                    i18n_1.i18n.setLocale(cliConfig.language);
                }
            }
        }
        catch (error) {
    ...
    saveLanguagePreference(lang) {
        ...
        try {
            ...
            console.warn(chalk_1.default.yellow(`Warning: Could not save language preference: ${error}`));
        }
    }
    setLanguage(lang) {
        i18n_1.i18n.setLocale(lang);
        this.saveLanguagePreference(lang);
        console.log(chalk_1.default.green(`✅ Language set to: ${lang === 'tr' ? 'Türkçe' : 'English'}`));
    }
}
...
program
    ...
    if (language === 'en' || language === 'tr') {
        ...
        console.error(chalk_1.default.red('❌ Supported languages: en, tr'));
    }
});
